...
from chhabi_documents.models import DocumentRequest
...
urlpatterns = [
    ...
    # Joining Letters routes
    path("joining-letters/templates/", views.joining_letter_template_list, name="joining-letter-template-list"),
    path("joining-letters/templates/create/", views.joining_letter_template_create, name="joining-letter-template-create"),
    path("joining-letters/templates/<int:template_id>/edit/", views.joining_letter_template_edit, name="joining-letter-template-edit"),
    path("joining-letters/templates/<int:template_id>/delete/", views.joining_letter_template_delete, name="joining-letter-template-delete"),
    path("joining-letters/issued/", views.issued_joining_letter_list, name="issued-joining-letter-list"),
    path("joining-letters/issue/", views.issue_joining_letter, name="issue-joining-letter"),
    path("joining-letters/preview/", views.preview_joining_letter, name="preview-joining-letter"),
    path("joining-letters/<int:letter_id>/action/<str:action_type>/", views.issued_joining_letter_action, name="issued-joining-letter-action"),
]
