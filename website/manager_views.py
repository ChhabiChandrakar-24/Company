...
from .models import (
    ...
    NavigationMenu, NavigationItem, ThemeSettings, MediaAsset,
    WebsiteSectionItem,
    WebsiteProduct, CarouselSlide,
)


CONFIG = {
    "pages": (WebsitePage, "Website Pages", ("title", "slug", "status", "updated_at"), None),
    "sections": (WebsiteSection, "Page Sections", ("heading", "page", "section_type", "is_active", "sort_order"), None),
    "section-items": (WebsiteSectionItem, "Structured Section Items", ("title", "section", "is_active", "sort_order"), None),
    "services": (WebsiteService, "Services", ("name", "slug", "is_active", "sort_order"), None),
    "products": (WebsiteProduct, "Products & Solutions", ("name", "item_type", "is_active", "sort_order"), None),
    "carousel": (CarouselSlide, "Carousel Slides", ("title", "is_active", "sort_order"), None),
    ...
    "navigation-menus": (NavigationMenu, "Navigation Menus", ("name", "slug", "is_active"), None),
    "navigation-items": (NavigationItem, "Navigation Items", ("label", "menu", "page", "url", "sort_order"), None),
    "theme-settings": (ThemeSettings, "Theme Settings", ("primary_color", "secondary_color", "is_active"), None),
    "media": (MediaAsset, "Media Library", ("title", "file", "uploaded_at"), None),
...
def _form_class(model, fields=None):
    excluded = {
        ...
        WebsiteSection: ("items", "settings"),
    }.get(model)
    class StyledForm(modelform_factory(model, fields=fields or "__all__", exclude=excluded)):
