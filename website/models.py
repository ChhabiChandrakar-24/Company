...
class WebsiteSettings(models.Model):
    ...
    map_embed_url = models.URLField(
        blank=True,
        help_text="Map embed URL; do not enter an API key here.",
    )
    map_directions_url = models.URLField(blank=True)
    header_cta_text = models.CharField(max_length=80, blank=True)
    header_cta_url = models.CharField(max_length=500, blank=True)
