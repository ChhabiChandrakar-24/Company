...
class OnboardingStage(ChhabiModel):
    """
    ...
    objects = ChhabiCompanyManager("recruitment_id__company_id")
...
class OnboardingTask(ChhabiModel):
    """
    ...
    objects = ChhabiCompanyManager("stage_id__recruitment_id__company_id")
...
class CandidateStage(ChhabiModel):
    """
...
class CandidateTask(ChhabiModel):
    """
    CandidateTask model
    """
...
class OnboardingPortal(ChhabiModel):
    """
