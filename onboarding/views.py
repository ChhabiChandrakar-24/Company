...
from base.models import ChhabiMailTemplate, JobPosition
...
from chhabi.group_by import group_by_queryset as general_group_by
...
def candidates_view(request):
    ...
    mail_templates = ChhabiMailTemplate.objects.all()
...
def email_send(request):
    ...
    bodys = list(
        ChhabiMailTemplate.objects.filter(id__in=template_attachment_ids).values_list(
            "body", flat=True
        )
    )
