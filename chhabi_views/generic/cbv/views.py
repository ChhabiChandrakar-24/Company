...
from chhabi.filters import FilterSet
from chhabi.group_by import group_by_queryset
from chhabi.chhabi_middlewares import _thread_locals
from chhabi.signals import post_generic_import, pre_generic_import
from chhabi_views import models
from chhabi_views.cbv_methods import (  # update_initial_cache,
    assign_related,
    export_xlsx,
...
from chhabi_views.forms import DynamicBulkUpdateForm, ToggleColumnForm
from chhabi_views.templatetags.generic_template_filters import getattribute

logger = logging.getLogger(__name__)


@method_decorator(hx_request_required, name="dispatch")
class ChhabiListView(ListView):
    """
    ChhabiListView
    """
    ...
    template_name: str = "generic/chhabi_list_table.html"
    ...
    def serve_import_sheet(self, request, *args, **kwargs):
        ...
        if not self.import_accessibility():
            ...
            return ChhabiFormView.HttpResponse()
    ...
    def get_context_data(self, **kwargs: Any):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[ChhabiListView] = context
        from chhabi.urls import path, urlpatterns
    ...
    def export_data(self, *args, **kwargs):
        ...
        class ChhabiListViewResorce(resources.ModelResource):
            """
        ...
        book_resource = ChhabiListViewResorce()
...
class ChhabiSectionView(TemplateView):
    """
    Chhabi Template View
    """
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, ChhabiListView)
    ...
    template_name = "generic/chhabi_section.html"
...
@method_decorator(hx_request_required, name="dispatch")
class ChhabiDetailedView(DetailView):
    """
    HorillDetailedView
    """

    title = "Detailed View"
    template_name = "generic/chhabi_detailed_view.html"
    header: dict = {
        "title": "Chhabi",
        "subtitle": "Chhabi Detailed View",
        "avatar": "",
    }
    body: list = []
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, ChhabiDetailedView)
...
@method_decorator(hx_request_required, name="dispatch")
class ChhabiTabView(TemplateView):
    """
    ChhabiTabView
    """

    view_id: str = get_short_uuid(3, "htv")
    template_name = "generic/chhabi_tabs.html"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.request = request
        self.query_params = {}
        # update_initial_cache(request, CACHE, ChhabiTabView)
    ...
    def get_context_data(self, **kwargs):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[ChhabiTabView] = context

        return context


@method_decorator(hx_request_required, name="dispatch")
class ChhabiCardView(ListView):
    """
    ChhabiCardView
    """
    ...
    template_name = "generic/chhabi_card.html"
    context_object_name = "queryset"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, ChhabiCardView)
    ...
    def get_context_data(self, **kwargs):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[ChhabiCardView] = context
        referrer = self.request.GET.get("referrer", "")
        if referrer:
            # Remove the protocol and domain part
            referrer = "/" + "/".join(referrer.split("/")[3:])
...
class ChhabiFormView(FormView):
    ...
    template_name = "generic/chhabi_form.html"
    ids_key: str = "instance_ids"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        # update_initial_cache(request, CACHE, ChhabiFormView)
    ...
    def get_form(self, form_class=None):
        ...
        if not hasattr(self, "form"):
            ...
            if self.request.method == "GET":
                ...
                for dynamic_tuple in self.dynamic_create_fields:
                    ...
                    form.fields[field].widget.option_template_name = (
                        "chhabi_widgets/select_option.html",
                    )
            ...
            # CACHE.get(self.request.session.session_key + "cbv")[ChhabiFormView] = form
            self.form = form
        return self.form
...
@method_decorator(hx_request_required, name="dispatch")
class ChhabiNavView(TemplateView):
    """
    ChhabiNavView
    ...
    template_name = "generic/chhabi_nav.html"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, ChhabiNavView)
    ...
    def get_context_data(self, **kwargs):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[ChhabiNavView] = context
        return context
...
@method_decorator(hx_request_required, name="dispatch")
class ChhabiProfileView(DetailView):
    """
    GenericChhabiProfileView
    """

    template_name = "generic/chhabi_profile_view.html"
    view_id: str = None
    filter_class: FilterSet = None
    push_url: str = None
    key_name: str = "pk"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.request = request
        self.ordered_ids_key = f"ordered_ids_{self.model.__name__.lower()}"
        # update_initial_cache(request, CACHE, ChhabiProfileView)
