...
from chhabi.signals import post_generic_delete, pre_generic_delete
from chhabi_views import models
from chhabi_views.cbv_methods import get_short_uuid, login_required, merge_dicts
from chhabi_views.forms import SavedFilterForm
from chhabi_views.generic.cbv.views import ChhabiFormView, ChhabiListView
...
class ReloadField(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        model: models.ChhabiModel = dynamic_cache["model"]
...
@method_decorator(login_required, name="dispatch")
class SavedFilter(ChhabiFormView):
    """
    SavedFilter
    """
...
class DynamiListView(ChhabiListView):
    """
...
class ChhabiDeleteConfirmationView(View):
    """
