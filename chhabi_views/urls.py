"""
chhabi_views/urls.py
"""

from django.urls import path

from chhabi_views import views
from chhabi_views.generic.cbv import history
from chhabi_views.generic.cbv.views import ReloadMessages
...
urlpatterns = [
    ...
    path(
        "generic-delete",
        views.ChhabiDeleteConfirmationView.as_view(),
        name="generic-delete",
    ),
    path(
        "chhabi-history-revert/<int:pk>/<int:history_id>/",
        history.ChhabiHistoryView.as_view(),
        name="history-revert",
    ),
]
