...
from chhabi.decorators import apply_decorators
...
class Bot:
    ...
    def get_avatar(self):
        ...
        Get avatar
        """
        return "https://ui-avatars.com/api/?name=Chhabi+Bot&background=random"
...
def history_tracking(request, obj_id, **kwargs):
    ...
    def _history_tracking(request, obj_id, model):
        ...
        histories = instance.chhabi_history.all()
        ...
        return render(
            request,
            "chhabi_audit/history_tracking.html",
            context,
        )
