...
@method_decorator(login_required, name="dispatch")
class TaskListView(ChhabiListView):
    """
...
@method_decorator(login_required, name="dispatch")
class TasksNavBar(ChhabiNavView):
    """
    navbar of teh page
    """
...
@method_decorator(login_required, name="dispatch")
class TaskCreateForm(ChhabiFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class TaskDetailView(ChhabiDetailedView):
    """
...
@method_decorator(login_required, name="dispatch")
class TaskCardView(ChhabiCardView):
    """
