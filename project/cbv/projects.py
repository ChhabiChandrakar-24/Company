...
from chhabi_views.cbv_methods import login_required, permission_required
...
class ProjectsNavView(ChhabiNavView):
    """
    Nav bar
    """
...
class ProjectsList(ChhabiListView):
    """
    Projects list view
    """
...
class ProjectFormView(ChhabiFormView):
    """
...
class ProjectCardView(ChhabiCardView):
    """
    For card view
    """
...
# Remove the command lines after chhabi converted into CBV
