"""
This module provides Chhabi ModelForms for creating and managing leave-related data,
...
from chhabi_widgets.forms import ChhabiForm, ChhabiModelForm
...
class LeaveOneAssignForm(ChhabiModelForm):
    """
    ...
    Attributes:
        - employee_id: A ChhabiMultiSelectField representing the employee to assign leave to.
    """
...
class AssignLeaveForm(ChhabiForm):
    """
    Form for Payslip
    """
