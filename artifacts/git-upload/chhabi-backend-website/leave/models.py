...
class CompanyLeave(ChhabiModel):
...
class AvailableLeave(ChhabiModel):
...
class LeaveRequest(ChhabiModel):
    employee_id = models.ForeignKey(
...
class LeaverequestComment(ChhabiModel):
    """
...
class LeaveAllocationRequest(ChhabiModel):
    leave_type_id = models.ForeignKey(
        LeaveType, on_delete=models.PROTECT, verbose_name=_("Leave type")
    )
    employee_id = models.ForeignKey(
...
class LeaveallocationrequestComment(ChhabiModel):
    """
...
class RestrictLeave(ChhabiModel):
...
if apps.is_installed("attendance"):
    ...
    class CompensatoryLeaveRequest(ChhabiModel):
        leave_type_id = models.ForeignKey(
...
class LeaveGeneralSetting(ChhabiModel):
    """
...
if apps.is_installed("attendance"):
    ...
    class CompensatoryLeaverequestComment(ChhabiModel):
        """
...
class EmployeePastLeaveRestrict(ChhabiModel):
...
if apps.is_installed("attendance"):
    ...
    class OverrideLeaveRequests(LeaveRequest):
        ...
        #     """
        #     WorkRecords = get_chhabi_model_class(
