...
from base.forms import ModelForm as ChhabiModelForm
...
from chhabi_widgets.widgets.chhabi_multi_select_field import ChhabiMultiSelectField
from chhabi_widgets.widgets.select_widgets import ChhabiMultiSelectWidget
...
class ObjectiveForm(BaseForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["assignees"] = ChhabiMultiSelectField(
            queryset=Employee.objects.all(),
            widget=ChhabiMultiSelectWidget(
        ...
        self.fields["managers"] = ChhabiMultiSelectField(
            queryset=Employee.objects.all(),
            widget=ChhabiMultiSelectWidget(
                filter_route_name="employee-widget-filter",
                filter_class=EmployeeFilter,
    ...
    def clean(self):
        ...
        for field_name, field_instance in self.fields.items():
            if isinstance(field_instance, ChhabiMultiSelectField):
...
class FeedbackForm(ChhabiModelForm):
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        # # Chhabi multi-select filter for subordinates
        # self.fields["subordinate_id"] = ChhabiMultiSelectField(
        #     queryset=Employee.objects.all(),
        #     widget=ChhabiMultiSelectWidget(
        #         filter_route_name="employee-widget-filter",
        #         filter_class=EmployeeFilter,
...
class MeetingsForm(BaseForm):
    ...
    def as_p(self):
        ...
        """
        context = {"form": self}
        table_html = render_to_string("chhabi_form.html", context)
        return table_html
    ...
    def clean(self):
        ...
        if isinstance(self.fields["employee_id"], ChhabiMultiSelectField):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["employee_id"] = ChhabiMultiSelectField(
...
class BonusPointSettingForm(ChhabiModelForm):
    """
...
class EmployeeBonusPointForm(ChhabiModelForm):
    """
...
class EmployeeFeedbackForm(ChhabiModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields["others_id"] = ChhabiMultiSelectField(
            queryset=Employee.objects.filter(employee_work_info__isnull=False),
            widget=ChhabiMultiSelectWidget(
                filter_route_name="employee-widget-filter",
                filter_class=EmployeeFilter,
    ...
    def clean(self):
        cleaned_data = super().clean()
        if isinstance(self.fields["others_id"], ChhabiMultiSelectField):
...
class BulkFeedbackForm(ChhabiModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields["employee_ids"] = ChhabiMultiSelectField(
            queryset=Employee.objects.filter(employee_work_info__isnull=False),
            widget=ChhabiMultiSelectWidget(
                filter_route_name="employee-widget-filter",
                filter_class=EmployeeFilter,
    ...
    def clean(self):
        cleaned_data = super().clean()
        if isinstance(self.fields["employee_ids"], ChhabiMultiSelectField):
