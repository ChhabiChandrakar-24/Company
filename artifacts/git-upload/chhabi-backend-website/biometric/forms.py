...
class DahuaUserForm(Form):
    """
    This form is used to map a Chhabi employee to a user entry on a Dahua biometric device.
    """
...
class MapBioUsers(ModelForm):
    """
    Form for mapping biometric users to Chhabi employees.

    This form is used to associate a biometric user (from a biometric device) with
    an employee in the Chhabi system.
    """
