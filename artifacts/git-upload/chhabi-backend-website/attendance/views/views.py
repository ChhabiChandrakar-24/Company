...
from chhabi.chhabi_settings import DYNAMIC_URL_PATTERNS, CHHABI_DATE_FORMATS
from chhabi.methods import remove_dynamic_url
...
def work_record_export(request):
    ...
    format_string = CHHABI_DATE_FORMATS.get(date_format)
