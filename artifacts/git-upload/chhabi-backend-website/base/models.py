...
class JobPosition(ChhabiModel):
    ...
    objects = ChhabiCompanyManager("department_id__company_id")
...
class JobRole(ChhabiModel):
    ...
    objects = ChhabiCompanyManager("job_position_id__department_id__company_id")
...
class RotatingWorkType(ChhabiModel):
    """
...
class RotatingWorkTypeAssign(ChhabiModel):
    """
...
class EmployeeType(ChhabiModel):
    """
    EmployeeType model
    """
...
class EmployeeShift(ChhabiModel):
    """
    EmployeeShift model
    """
    ...
    objects = ChhabiCompanyManager("employee_shift__company_id")
...
class EmployeeShiftSchedule(ChhabiModel):
    """
    ...
    auto_punch_out_time = models.TimeField(
        ...
        help_text=_(
            "Time at which the chhabi will automatically check out the employee attendance if they forget."
        ),
    )
    company_id = models.ManyToManyField(Company, blank=True, verbose_name=_("Company"))

    objects = ChhabiCompanyManager("shift_id__employee_shift__company_id")
...
class RotatingShift(ChhabiModel):
    """
    RotatingShift model
    """
...
class RotatingShiftAssign(ChhabiModel):
    """
...
class WorkTypeRequest(ChhabiModel):
    """
...
class WorkTypeRequestComment(ChhabiModel):
    """
...
class ShiftRequest(ChhabiModel):
    """
    ShiftRequest model
    """
...
class ShiftRequestComment(ChhabiModel):
    """
...
class Tags(ChhabiModel):
    title = models.CharField(max_length=30)
    color = models.CharField(max_length=30)
    company_id = models.ForeignKey(
        Company, null=True, editable=False, on_delete=models.PROTECT
    )
    objects = ChhabiCompanyManager(related_company_field="company_id")
...
class ChhabiMailTemplate(ChhabiModel):
...
class DynamicEmailConfiguration(ChhabiModel):
    """
...
class MultipleApprovalCondition(ChhabiModel):
...
class Announcement(ChhabiModel):
    """
...
class AnnouncementComment(ChhabiModel):
    """
...
class DashboardEmployeeCharts(ChhabiModel):
    from employee.models import Employee
...
class TrackLateComeEarlyOut(ChhabiModel):
...
class CompanyLeaves(ChhabiModel):
...
class PenaltyAccounts(ChhabiModel):
    """
