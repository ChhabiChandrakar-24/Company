...
from chhabi_audit.models import AuditTag
...
class AssignPermission(Form):
    ...
    employee = ChhabiMultiSelectField(
...
class JobPositionMultiForm(ModelForm):
    ...
    department_id = ChhabiMultiSelectField(
...
class AnnouncementForm(ModelForm):
    ...
    employees = ChhabiMultiSelectField(
        queryset=Employee.objects.all(),
        widget=ChhabiMultiSelectWidget(
            filter_route_name="employee-widget-filter",
            filter_class=EmployeeFilter,
    ...
    def clean(self):
        ...
        if isinstance(self.fields["employees"], ChhabiMultiSelectField):
