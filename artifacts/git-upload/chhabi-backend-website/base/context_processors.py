...
from chhabi.decorators import hx_request_required, login_required, permission_required
...
def resignation_request_enabled(request):
    ...
    if apps.is_installed("offboarding"):
        OffboardingGeneralSetting = get_chhabi_model_class(
...
def timerunner_enabled(request):
    ...
    if apps.is_installed("attendance"):
        AttendanceGeneralSetting = get_chhabi_model_class(
...
def intial_notice_period(request):
    ...
    if apps.is_installed("payroll"):
        PayrollGeneralSetting = get_chhabi_model_class(
...
def check_candidate_self_tracking(request):
    ...
    if apps.is_installed("recruitment"):
        RecruitmentGeneralSetting = get_chhabi_model_class(
