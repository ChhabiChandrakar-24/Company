...
from chhabi_views.cbv_methods import login_required
from chhabi_views.generic.cbv.views import (
    ChhabiCardView,
    ChhabiDetailedView,
    ChhabiFormView,
    ChhabiListView,
...
class TimeSheetNavView(ChhabiNavView):
    """
    Nav bar
    """
...
class TimeSheetList(ChhabiListView):
    """
...
class TaskTimeSheet(TimeSheetList):
    ...
    def get_queryset(self):
        queryset = ChhabiListView.get_queryset(self)
        task_id = self.kwargs.get("task_id")
...
class TimeSheetFormView(ChhabiFormView):
    """
...
class TimeSheetCardView(ChhabiCardView):
    """
    For card view
    """
...
class TimeSheetDetailView(ChhabiDetailedView):
    """
