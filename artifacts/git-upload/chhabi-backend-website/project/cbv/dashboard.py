...
from chhabi_views.generic.cbv.views import ChhabiDetailedView, ChhabiListView
...
class ProjectsDueInMonth(ChhabiListView):
...
class ProjectDetailView(ChhabiDetailedView):
    """
