...
This module defines the abstract base model `ChhabiModel` for the Chhabi HRMS project.
The `ChhabiModel` provides common fields and functionalities for other models within
...
class ChhabiModel(models.Model):
    """
    An abstract base model that includes common fields and functionalities
    for models within the Chhabi application.
    """
    ...
    chhabi_history = AuditlogHistoryField()
    objects = models.Manager()
    is_active = models.BooleanField(default=True, verbose_name=_("Is Active"))

    class Meta:
        """
        Meta class for ChhabiModel
        """
    ...
    def save(self, *args, **kwargs):
        ...
        super(ChhabiModel, self).save(*args, **kwargs)
...
auditlog.register(ChhabiModel, serialize_data=True)
