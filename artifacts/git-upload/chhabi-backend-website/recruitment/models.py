...
class SurveyTemplate(ChhabiModel):
    """
...
class Stage(ChhabiModel):
    ...
    objects = ChhabiCompanyManager(related_company_field="recruitment_id__company_id")
...
class RejectReason(ChhabiModel):
    """
    RejectReason
    """
...
class RejectedCandidate(ChhabiModel):
    """
    RejectedCandidate
    """
...
class RecruitmentSurvey(ChhabiModel):
    """
    ...
    objects = ChhabiCompanyManager(related_company_field="recruitment_ids__company_id")
...
class QuestionOrdering(ChhabiModel):
    """
...
class RecruitmentSurveyAnswer(ChhabiModel):
    """
...
class SkillZoneCandidate(ChhabiModel):
    """
...
class CandidateRating(ChhabiModel):
...
class RecruitmentGeneralSetting(ChhabiModel):
    """
...
class InterviewSchedule(ChhabiModel):
    """
    ...
    objects = ChhabiCompanyManager("candidate_id__recruitment_id__company_id")
...
class CandidateDocumentRequest(ChhabiModel):
    title = models.CharField(max_length=100)
...
class CandidateDocument(ChhabiModel):
...
class LinkedInAccount(ChhabiModel):
