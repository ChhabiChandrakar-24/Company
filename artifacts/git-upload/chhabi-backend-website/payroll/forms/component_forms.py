...
from chhabi_widgets.forms import ChhabiForm, default_select_option_template
...
class AllowanceForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["specific_employees"] = ChhabiMultiSelectField(
...
class GeneratePayslipForm(ChhabiForm):
    """
    Form for Payslip
    """
    ...
    employee_id = ChhabiMultiSelectField(
...
class ReimbursementForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.request = getattr(chhabi_middlewares._thread_locals, "request", None)
    ...
    def get_encashable_leaves(self, employee):
        LeaveType = get_chhabi_model_class(app_label="leave", model="leavetype")
    ...
    def setup_leave_fields(self):
        ...
        AvailableLeave = get_chhabi_model_class(
        ...
        if type_ == "bonus_encashment":
            ...
            if not leave_type:
                ...
                if leave_type not in encashable:
                    ...
                    AvailableLeave = get_chhabi_model_class("leave", "availableleave")
