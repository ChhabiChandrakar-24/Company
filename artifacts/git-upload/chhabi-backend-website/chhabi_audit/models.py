...
from chhabi_audit.methods import remove_duplicate_history
...
class AuditTag(models.Model):
    ...
    class Meta:
        ...
        app_label = "chhabi_audit"


class ChhabiAuditInfo(models.Model):
    """
    ChhabiAuditInfo model to store additional info
    """
...
class ChhabiAuditLog(HistoricalRecords):
    """
    Model to store additional information for historical records.
    """

    # def __init__(self, *args, bases=None, **kwargs):
    #     super(ChhabiAuditLog, self).__init__(*args, **kwargs)
    #     self.is_chhabi_audit_log = True
...
def pre_create_chhabi_audit_log(sender, instance, *args, **kwargs):
    """
...
def post_create_chhabi_audit_log(sender, instance, *_args, **kwargs):
    """
    ...
    try:
        ...
        if isinstance(history_instance, ChhabiAuditLog):
