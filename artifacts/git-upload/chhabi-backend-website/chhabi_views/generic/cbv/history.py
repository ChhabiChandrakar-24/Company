"""
chhabi_views/generic/cbv/history.py
"""
...
from chhabi_views.cbv_methods import hx_request_required
from chhabi_views.generic.cbv.views import ChhabiFormView
from chhabi_views.history_methods import get_diff


@method_decorator(hx_request_required, name="dispatch")
class ChhabiHistoryView(DetailView):
    """
    GenericChhabiProfileView
    """

    template_name = "generic/chhabi_history_view.html"
