...
class AssetCategory(ChhabiModel):
    """
...
class Asset(ChhabiModel):
    ...
    objects = ChhabiCompanyManager("asset_category_id__company_id")
...
class AssetDocuments(ChhabiModel):
    """
...
class ReturnImages(ChhabiModel):
    """
...
class AssetAssignment(ChhabiModel):
    """
    ...
    objects = ChhabiCompanyManager("asset_id__asset_lot_number_id__company_id")
...
class AssetRequest(ChhabiModel):
    """
