...
class AttendanceActivity(ChhabiModel):
    """
...
class BatchAttendance(ChhabiModel):
    """
...
class AttendanceRequestFile(ChhabiModel):
    file = models.FileField(upload_to=upload_path)


class AttendanceRequestComment(ChhabiModel):
    """
...
class AttendanceOverTime(ChhabiModel):
    """
...
class AttendanceLateComeEarlyOut(ChhabiModel):
    """
...
class AttendanceValidationCondition(ChhabiModel):
    """
...
class AttendanceGeneralSetting(ChhabiModel):
    """
