...
urlpatterns = [
    ...
    path("termination/", views.termination_list, name="termination-list"),
    path("termination/initiate/", views.termination_initiate, name="termination-initiate"),
    path("termination/<int:termination_id>/", views.termination_detail, name="termination-detail"),
    path("termination/<int:termination_id>/approve/", views.termination_approve, name="termination-approve"),
    path("termination/<int:termination_id>/reject/", views.termination_reject, name="termination-reject"),
    path("termination/<int:termination_id>/update-checklist/", views.termination_update_checklist, name="termination-update-checklist"),
    path("termination/<int:termination_id>/complete/", views.termination_complete, name="termination-complete"),
]
