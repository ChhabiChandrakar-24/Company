...
class OffboardingStage(ChhabiModel):
    """
    Offboarding model
    """
...
class OffboardingStageMultipleFile(ChhabiModel):
    """
...
class OffboardingEmployee(ChhabiModel):
    """
...
class ResignationLetter(ChhabiModel):
    """
...
class OffboardingTask(ChhabiModel):
    """
...
class EmployeeTask(ChhabiModel):
    """
    EmployeeTask model
    """
...
class OffboardingNote(ChhabiModel):
    """
    OffboardingNote
    """
...
class OffboardingGeneralSetting(ChhabiModel):
    """
...
class TerminationWorkflow(ChhabiModel):
    STATUS_CHOICES = (
        ("initiated", "Initiated"),
    ...
    initiated_by = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, related_name="initiated_terminations")
    reason = models.TextField()
    effective_date = models.DateField()
    status = models.CharField(max_length=20, choices=STATUS_CHOICES, default="initiated")
    termination_letter = models.TextField(blank=True, null=True, help_text="Termination letter content")
    ...
    def __str__(self):
        return f"Termination of {self.employee.get_full_name()} ({self.status})"
