...
from chhabi.decorators import login_required, owner_can_enter, permission_required
...
class BonusPointSettingSectionView(views.ChhabiSectionView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("pms.view_bonuspointsetting"), name="dispatch")
class BonusPointSettingNavView(views.ChhabiNavView):
    """
...
class BonusPointSettingFormView(views.ChhabiFormView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("pms.view_bonuspointsetting"), name="dispatch")
class BonusPointSettingListView(views.ChhabiListView):
    """
...
class EmployeeBonusPointSectionView(views.ChhabiSectionView):
    """
...
class EmployeeBonusPointNavView(views.ChhabiNavView):
    """
    BonusPoint nav view
    """
...
class EmployeeBonusPointFormView(views.ChhabiFormView):
    """
    BonusPointForm View
    """
...
class EmployeeBonusPointListView(views.ChhabiListView):
    """
    BnusPoint list view
    """
...
@method_decorator(login_required, name="dispatch")
class FeedbackEmployeeFormView(views.ChhabiFormView):
    """
...
class BulkFeedbackFormView(views.ChhabiFormView):
    """
    Feedback other employee form View
    """
