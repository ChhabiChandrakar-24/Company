...
from chhabi_audit.methods import history_tracking
from pms import cbvs

from . import call_views, developer_api_views, models, subscription_views, views, invitation_views

urlpatterns = [
    # Call Room & Signaling
    path("meeting-call/<uuid:room_code>/", call_views.meeting_room, name="meeting-call"),
    path("meeting-call/<uuid:room_code>/feed/", call_views.meeting_feed, name="meeting-call-feed"),
    path("meeting-call/<uuid:room_code>/message/", call_views.meeting_message, name="meeting-call-message"),
    path("meeting-call/<uuid:room_code>/caption/", call_views.meeting_caption, name="meeting-call-caption"),
    path("meeting-call/<uuid:room_code>/note/", call_views.meeting_note, name="meeting-call-note"),
    path("meeting-call/<uuid:room_code>/signal/", call_views.meeting_signal, name="meeting-call-signal"),
    path("meeting-call/<uuid:room_code>/recording/", call_views.meeting_recording, name="meeting-call-recording"),
    path("meeting-provider-settings/", call_views.provider_settings, name="meeting-provider-settings"),
    path("create-meeting-shortcut/", call_views.create_meeting_shortcut, name="create-meeting-shortcut"),
    path("meeting-reminders/", call_views.meeting_reminders, name="meeting-reminders"),
    path("meeting/<int:meeting_id>/provision/", call_views.provision_provider_meeting, name="meeting-provider-provision"),
    path("meeting-recording/<int:recording_id>/download/", call_views.recording_download, name="meeting-recording-download"),
    path("meeting-recording/<int:recording_id>/delete/", call_views.recording_delete, name="meeting-recording-delete"),

    # Subscription & Payment Gateways (Razorpay & PhonePe)
    path("subscription/plans/", subscription_views.subscription_plans_view, name="meeting-subscription-plans"),
    path("subscription/checkout/order/", subscription_views.create_checkout_order, name="meeting-subscription-order"),
    path("subscription/razorpay/verify/", subscription_views.razorpay_verify_payment, name="meeting-razorpay-verify"),
    path("subscription/phonepe/callback/", subscription_views.phonepe_callback, name="meeting-phonepe-callback"),
    path("subscription/transactions/", subscription_views.transaction_history_view, name="meeting-subscription-transactions"),
    path("subscription/admin/gateways/", subscription_views.admin_gateway_list, name="meeting-admin-gateways"),
    path("subscription/admin/gateways/<int:gateway_id>/edit/", subscription_views.admin_gateway_edit, name="meeting-admin-gateways-edit"),
    path("subscription/admin/plans/", subscription_views.admin_plans_list, name="meeting-admin-plans"),
    path("subscription/admin/plans/create/", subscription_views.admin_plan_create, name="meeting-admin-plans-create"),
    path("subscription/admin/plans/<int:plan_id>/edit/", subscription_views.admin_plan_edit, name="meeting-admin-plans-edit"),
    path("subscription/admin/plans/<int:plan_id>/archive/", subscription_views.admin_plan_archive, name="meeting-admin-plans-archive"),
    path("subscription/admin/plans/<int:plan_id>/toggle/", subscription_views.admin_plan_toggle, name="meeting-admin-plans-toggle"),
    path("subscription/admin/billing/", subscription_views.admin_billing_dashboard, name="meeting-admin-billing"),
    path("subscription/admin/billing/custom-offer/", subscription_views.admin_custom_offer, name="meeting-admin-custom-offer"),
    path("subscription/admin/billing/manual-grant/", subscription_views.admin_manual_grant, name="meeting-admin-manual-grant"),

    # Developer Platform (Zoom-like Developer API & Portal)
    path("developer/portal/", developer_api_views.developer_portal_view, name="developer-portal"),
    path("developer/keys/generate/", developer_api_views.generate_api_key_view, name="developer-key-generate"),
    path("developer/keys/<int:key_id>/revoke/", developer_api_views.revoke_api_key_view, name="developer-key-revoke"),

    # Public Developer REST API (Zoom v1 equivalent endpoints)
    path("api/v1/meetings/create/", developer_api_views.api_create_meeting, name="api-meeting-create"),
    path("api/v1/meetings/<int:meeting_id>/", developer_api_views.api_get_meeting, name="api-meeting-get"),
    path("api/v1/meetings/<int:meeting_id>/join-token/", developer_api_views.api_generate_join_token, name="api-meeting-join-token"),
    path("api/v1/meetings/<int:meeting_id>/recordings/", developer_api_views.api_list_recordings, name="api-meeting-recordings"),
    path("api/v1/developer/usage/", developer_api_views.api_developer_usage, name="api-developer-usage"),
    ...
    path("saas/dashboard/", views.saas_dashboard_view, name="saas-dashboard"),
    path("saas/organization/create/", views.saas_create_org_view, name="saas-create-org"),
    path("saas/members/", views.saas_members_view, name="saas-members"),
    path("saas/members/add/", views.saas_add_member_view, name="saas-add-member"),
    path("saas/subscription/change/", views.saas_change_subscription_view, name="saas-change-plan"),
    path(
    ...
    path("meeting/<int:meeting_id>/invitation/create/", invitation_views.create_meeting_invitation, name="meeting-invitation-create"),
    path("meeting/<int:meeting_id>/invitation/<str:token>/revoke/", invitation_views.revoke_meeting_invitation, name="meeting-invitation-revoke"),
    path("meeting/<int:meeting_id>/invitation/<str:token>/join/", invitation_views.join_meeting_invitation, name="meeting-invitation-join"),
