...
from chhabi.signals import post_bulk_update, pre_bulk_update
...
def start_automation():
    ...
    from chhabi_automations.methods.methods import get_model_class, split_query_string
    ...
    @receiver(post_delete, sender=ChhabiMailTemplate)
    @receiver(post_save, sender=ChhabiMailTemplate)
...
def send_automated_mail(
    ...
    from chhabi_automations.methods.methods import evaluate_condition, operator_map
...
def send_mail(request, automation, instance):
    ...
    from chhabi_automations.methods.methods import (
        get_model_class,
