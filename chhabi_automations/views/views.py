"""
chhabi_automation/views/views.py
"""
...
from chhabi_automations.signals import REFRESH_METHODS
from chhabi_views.generic.cbv.views import ChhabiFormView
...
@login_required
@permission_required("chhabi_automations.delete_mailautomation")
...
@login_required
@permission_required("chhabi_automations.add_mailautomation")
