...
This module is used to write chhabi form select widgets
"""
...
class ChhabiMultiSelectWidget(forms.Widget):
    """
    ChhabiMultiSelectWidget
    """
    ...
    template_name = "chhabi_widgets/chhabi_multiselect_widget.html"
