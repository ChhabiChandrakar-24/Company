...
class LinkedinSettingSectionView(views.ChhabiSectionView):
    """
...
class LinkedInSettingNavView(views.ChhabiNavView):
    """
...
class LinkedInAccountFormView(views.ChhabiFormView):
    """
    LinkedInForm View
    """
...
class LinkedInSettingListView(views.ChhabiListView):
    """
