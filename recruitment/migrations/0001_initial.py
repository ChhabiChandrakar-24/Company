    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile', models.ImageField(null=True, upload_to=chhabi.models.upload_path)),
                ...
                ('resume', models.FileField(upload_to=chhabi.models.upload_path, validators=[recruitment.models.validate_pdf])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, null=True, verbose_name='Created At')),
                ('is_active', models.BooleanField(default=True, verbose_name='Is Active')),
                ('files', models.FileField(blank=True, null=True, upload_to=chhabi.models.upload_path)),
                ('created_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Created By')),
                ('modified_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_modified_by', to=settings.AUTH_USER_MODEL, verbose_name='Modified By')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(upload_to=chhabi.models.upload_path, validators=[recruitment.models.validate_pdf])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attachment', models.FileField(blank=True, null=True, upload_to=chhabi.models.upload_path)),
                ('candidate_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='recruitment.candidate')),
                ('created_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Created By')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_tags', models.ManyToManyField(to='chhabi_audit.audittag')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document', models.FileField(null=True, upload_to=chhabi.models.upload_path)),
