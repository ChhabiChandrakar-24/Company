...
urlpatterns = [
    # Keep Horilla's internal home URL separate from the public website root.
    # Existing sidebar/templates reverse `home-page`, so this preserves the
    # complete original dashboard navigation and UI at /dashboard/.
    ...
    path(
        "forgot-password",
        views.ChhabiPasswordResetView.as_view(),
    ...
    path(
        "get-chhabi-installed-apps/",
        views.get_chhabi_installed_apps,
        name="get-chhabi-installed-apps",
    ),
