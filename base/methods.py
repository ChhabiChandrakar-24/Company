...
from chhabi.chhabi_apps import NESTED_SUBORDINATE_VISIBILITY
from chhabi.chhabi_middlewares import _thread_locals
from chhabi.chhabi_settings import CHHABI_DATE_FORMATS, CHHABI_TIME_FORMATS
...
def format_export_value(value, employee):
    ...
    if isinstance(value, time):
        ...
        for format_name, format_string in CHHABI_TIME_FORMATS.items():
