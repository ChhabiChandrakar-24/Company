...
class DefaultChhabiMailBackend(EmailBackend):
    def __init__(
        self,
        host=None,
        port=None,
...
BACKEND_CLASS: EmailBackend = DefaultChhabiMailBackend
default = "base.backends.ConfiguredEmailBackend"

setattr(BACKEND_CLASS, "send_messages", DefaultChhabiMailBackend.send_messages)
