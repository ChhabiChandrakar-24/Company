"""
chhabi_api/urls/attendance/urls.py
"""

from django.urls import path

from chhabi_api.api_views.attendance.permission_views import AttendancePermissionCheck
from chhabi_api.api_views.attendance.views import *
